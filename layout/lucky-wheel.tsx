    ...
    <div className="">
      ...
      <div className="mt-5">
        ...
        <ul className="space-y-1 text-gray-500 list-disc list-inside dark:text-gray-400">
          <li>
            Sau khi hoàn thành đơn hàng đầu tiên, bạn có thể tham gia vòng quay
            may mắn
          </li>
          <li>
            Mỗi ngày bạn sẽ có 1 lượt quay miễn phí, sau đó mỗi lần sau sẽ mất
            100Đ.
          </li>
          <li>
      ...
      >
        <p>
          Phần thưởng của bạn là: <span className="text-success">{prize}</span>
        </p>
      </BaseModal>
    </div>
  );
