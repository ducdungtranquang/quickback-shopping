      ...
      <main className="isolate">
              ...
              <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                <div className="relative w-full lg:max-w-xs lg:shrink-0">
                  ...
                  <p className="mt-8 text-pretty text-lg font-medium text-gray-500 sm:max-w-md sm:text-xl/8 lg:max-w-none">
                    ...
                    đãi, dịch vụ tốt nhất. Chúng tôi cam kết hoàn lại tiền thật
                    100%. An toàn, bảo mật và đáng tin cậy
                  </p>
                </div>
            ...
            <div className="mt-6 flex flex-col gap-x-8 gap-y-20 lg:flex-row">
              <div className="lg:w-full lg:max-w-2xl lg:flex-auto">
                <p className="text-xl/8 text-gray-600">
                  Giúp người tiêu dùng tiết kiệm chi phí 1 cách tốt nhất, giúp
                  việc mua sắm trở nên dễ dàng và thú vị hơn
                </p>
                <p className="mt-10 max-w-xl text-base/7 text-gray-700">
                  Dễ dàng nắm bắt những sản phẩm hot trend, những ưu đãi lớn và
                  những sự kiện hoàn tiền lớn trong năm
                </p>
              </div>
              <div className="lg:flex lg:flex-auto lg:justify-center">
                <dl className="w-64 space-y-8 xl:w-80">
                  {statsOur.map((stat) => (
                    ...
                    >
                      <dt className="text-2xl text-gray-600">{stat.label}</dt>
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            <p className="mt-6 text-lg/8 text-gray-600">
              Luôn đặt người dùng là ưu tiên số 1
            </p>
          </div>
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-48 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            <p className="mt-6 text-lg/8 text-gray-600">
              Chúng tôi luôn cố gắng hết sức để hiểu hơn về người dùng, về những
              khó khăn, vướng mắc khi mua hàng, từ đó không ngừng cải thiện,
              nâng cấp để mang đến cho khách hàng sản phẩm tốt nhất
            </p>
          </div>
          <ul
            role="list"
