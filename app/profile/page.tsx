...
const App = () => {
  ...
  return (
    <div className="mt-[100px] sm:mt-[100px] h-full min-h-screen lg:h-screen lg:overflow-hidden bg-gray-100 flex flex-col justify-start items-center p-5 pt-0">
      ...
      <div className="flex flex-col sm:flex-row justify-around items-center w-full gap-[10px]">
        <InfoCard message={"Thông tin cá nhân"} link="/" />
        <InfoCard message={"Hỗ trợ"} link="/" />
      </div>
      <div className="flex flex-col sm:flex-row justify-around items-center w-full gap-[10px]">
        <InfoCard message={"Mã giới thiệu"} link="/" />
        <InfoCard message={"Tham gia Telegram"} link="/" />
      </div>
